...
namespace Engine {
	...
	{
		AssetFilePtr fp = OpenFile(filePath, AssetOpenMode::MY_OPEN_BINARY);
...
#endif
				switch (mode) {
				case AssetOpenMode::MY_OPEN_TEXT:
					fopen_s(&fp, fullPath.c_str(), "r");
					break;
				case AssetOpenMode::MY_OPEN_BINARY:
	...
	{
		AssetFilePtr fp = OpenFile(filePath, AssetOpenMode::MY_OPEN_TEXT);
